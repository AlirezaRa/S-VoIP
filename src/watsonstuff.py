...
def callWatson(thing):
    ...
    # Then cvlc streams it through the messanger that's already loaded with PULSE_SOURCE variable (should have used with main.loadNull())
...
def mainSpeech():
    ...
    # a string of the content. That is passed to Watson. Since sox has to record only one sentence, it needs to be killed 
...
def saySpanish(thing):
    # Same as callWatson. The only difference is that gtranslate translates @thing into Spanish!
